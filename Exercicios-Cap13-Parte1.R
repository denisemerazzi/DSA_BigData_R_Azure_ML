...
setwd("C:/Users/deeww/OneDrive/Ãrea de Trabalho/Ciencia de dados/Curso FormaÃ§Ã£o Cientista de dados/BigData_R_Azure_ML/cap13")
getwd()
...
# Impute missing values - substituir valores Na
...
# Invocando o método NaiveBayes - Teoria das probabilidades
