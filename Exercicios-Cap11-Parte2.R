...
setwd("C:/Users/deeww/OneDrive/Ãrea de Trabalho/Ciencia de dados/Curso FormaÃ§Ã£o Cientista de dados/BigData_R_Azure_ML/cap11")
getwd()

# Regressão Linear (porque é um problema numérico)
...
##Filtrando as colunas numéricas para investigar a correlação
data_cor <- cor(df[,colunas_numericas])
data_cor
head(data_cor)

##Pacotes para visualizar a correlação
...
# Gerando o Modelo (Usando todos os atributos) - várias versões
...
# Tratando os valores negativos - criando uma função para tratar valores negativos
