...
# Histograma da variável len (comprimento dos dentes)
...
# Teste de Normalidade Shapiro-Wilk (este deve ser o primeiro teste,
#para que eu saiba se os dados estão normalmente distribuídos)
