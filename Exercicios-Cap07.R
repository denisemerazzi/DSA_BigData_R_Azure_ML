...
setwd("C:/Users/deeww/OneDrive/Área de Trabalho/Ciencia de dados/Curso Formação Cientista de dados/BigData_R_Azure_ML/cap7")
getwd()
...
previsao <- html_nodes(pagina, "#detailed-forecast-body b  e .forecast-text")
...
# LOcaliza os padrões através da função pattern (nesse caso temos 
# o time e os pontos na mesma coluna, temos que separar)
pattern <- " \\d+$"
...
write.csv(tab,'superbowl.csv', row.nomes = F)
