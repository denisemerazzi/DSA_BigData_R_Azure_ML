# Solução Lista de Exercícios - Capítulo 9 - 03/07/2022


# Configurando o diretório de trabalho

setwd("C:/Users/deeww/OneDrive/Área de Trabalho/Ciencia de dados/Curso Formação Cientista de dados/BigData_R_Azure_ML/cap09")
getwd()
...
###Pode ser resolvido com uma função binomial
## 7 = parametro, é a questão; 10 = total de pacientes; 0.8 = percentual de adultos que relatam a eficacia  
a <- dbinom(7,10,0.8)
print(a)
...
pnorm(84, mean=72, sd=15.2, lower.tail=FALSE) ###cauda inferior é falsa (procuramos a cauda superior)
...
#Porque: reduz a taxa de processamento, reduz o tempo 
pexp(2, rate=1/3) 
