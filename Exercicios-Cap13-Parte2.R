# Solução Lista de Exercícios parte 2 - Capítulo 13


# Configurando o diretório de trabalho

setwd("C:/Users/deeww/OneDrive/Ãrea de Trabalho/Ciencia de dados/Curso Formação Cientista de dados/BigData_R_Azure_ML/cap13")
getwd()
...
View(dados_treino)
##zero não sobreviveu, 1 sobreviveu
...
install.packages("Amelia") ## possui uma função para mapear valores missing
library(Amelia)
