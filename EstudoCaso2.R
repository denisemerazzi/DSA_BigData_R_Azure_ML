# Estatística na Prática 2 - Teste de Shapiro-Wilk, Teste F e Teste t - 03/07/2022
...
qqPlot(sleep$extra[! grupo_dois])  ##Negação (encontra o grupo 1)
                                   ## os dois grupos seguem a distribuição normal
...
# O valor-p do teste de cada grupo é maior que 0.05 e então falhamos em rejeitar a H0.(Aceita H0)
...
###Teste F
?var.test  ##compara duas variâncias
...
# H0 (Hipótese Nula) – Não há diferença significativa entre as médias dos 2 grupos (aceita H0)
?t.test
